            ...
            <div>
              {tournaments.length > 0 ? (
                tournaments.slice(0, 3).map((t, idx) => (
                  <div
                    key={t.id}
                    className="flex items-center justify-between transition-all duration-120 cursor-pointer"
                    style={{
                      padding: '11px 18px',
                      borderBottom: '1px solid #f8fafc'
                    }}
                  ...
                  >
                    <div className="min-w-0">
                      <p style={{ fontSize: '13px', fontWeight: 600, color: '#0f172a' }} className="truncate">
                        {chessSymbols[idx % chessSymbols.length]} {t.title}
                      </p>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: '2px' }}>
                        ...
                        <p style={{ fontSize: '11px', color: '#94a3b8' }}>
                          {t.date && !isNaN(new Date(t.date).getTime())
                            ...
                            : <span style={{ fontStyle: 'italic', color: '#94a3b8' }}>Date TBD</span>
                          }
                        </p>
                      </div>
                    </div>
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">No events scheduled</p>
                </div>
              )}
            </div>
          </div>
