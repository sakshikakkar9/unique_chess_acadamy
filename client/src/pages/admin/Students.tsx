        ...
        <div className="flex justify-start w-full">
          ...
          >
            <span className={cn(
              ...
              student.accountStatus === 'ACTIVE' ? 'bg-emerald-500' : 'bg-uca-accent-red'
            )} />
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end items-center mb-4 sm:mb-6">
        <div className="flex items-center gap-2 sm:gap-3">
          <Button
            ...
            className="h-9 w-9 sm:h-10 sm:w-10 p-0 flex items-center justify-center rounded-lg border-uca-border bg-uca-bg-surface text-uca-text-primary hover:bg-uca-bg-elevated transition-colors"
          >
          ...
          <Button
            onClick={handleAdd}
            title="Add Student"
            className="h-9 w-9 sm:h-10 sm:w-10 p-0 flex items-center justify-center rounded-lg bg-uca-navy hover:bg-uca-navy-hover text-white transition-colors"
          >
      ...
      <div className="space-y-4 sm:space-y-6">
        {/* Filter Bar */}
        <div className="flex flex-col gap-3 bg-uca-bg-surface border border-uca-border p-3 sm:p-4 rounded-xl mb-4 sm:mb-6">
          {/* Search — full width */}
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            ...
            <Select value={courseFilter} onValueChange={setCourseFilter}>
              <SelectTrigger className="h-10 w-full sm:w-48 bg-uca-bg-base border-uca-border text-[10px] font-black uppercase tracking-widest">
                <div className="flex items-center gap-2">
                  <BookOpen className="size-3.5 text-uca-accent-blue shrink-0" />
...
//           )}
//         >
//           <span className={cn("size-1.5 rounded-full mr-1.5", student.accountStatus === 'ACTIVE' ? 'bg-emerald-500' : 'bg-uca-accent-red')} />
//           {student.accountStatus}
//         </span>
//       </div>
//     )
