...
const CoursePortal: React.FC = () => {
  ...
  if (!course) return <div className="p-4 md:p-8 text-center font-bold text-rose-500">Course not found</div>;
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 bg-sky-50 text-sky-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-sky-100">Course Portal</span>
        ...
        <TabsContent value="finance" className="mt-0 focus-visible:ring-0 space-y-8">
           ...
           <div className="bg-white rounded-[24px] border border-slate-100 shadow-sm p-4 md:p-8 space-y-6">
              <div className="flex items-center gap-3">
                 ...
                 <h3 className="text-sm font-black uppercase tracking-widest text-slate-900">Additional Course Details</h3>
              </div>
