...
import { Mail, Trash2, Search, Filter, Check } from "lucide-react";
...
export default function MessagesPage() {
  ...
  // Client-side search and status filter sorting
  ...
  return (
    <AdminShell title="Messages" subtitle="View and manage inquiries from the contact form.">
      ...
      {/* Slideout Message Details Sheet */}
